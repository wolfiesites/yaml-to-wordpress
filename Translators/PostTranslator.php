...
class PostTranslator {
		...
		foreach ($taxonomy_definition as $tax) {
			...
			if (is_string($args['show_in_menu'])) {
				add_action('admin_menu', function() use ($tax_name, $show_in_menu, $tax_name_with_suffix, $position_in_menu){
					self::register_custom_post_type($tax_name, $show_in_menu, $tax_name_with_suffix, $position_in_menu);
				}, 99);
	...
	public static function register_custom_post_type($tax_name, $show_in_menu, $tax_name_with_suffix, $position_in_menu) {
